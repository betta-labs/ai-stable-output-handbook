...
> **本章路标**：要避免的误判是“流程越动态，价值越高”；本章产出是一套自主性决策、权限边界和人工接管路径；如果固定工作流已经能在可接受的成本与风险下完成任务，应先跳过本章的 Agent 编排，回到[第 4 章](04-第4章-从单次生成到可复现工作流.md)固化方法。
>
...
Agent 是一个在受控上下文、外部工具与状态之间进行有限编排的概率系统。它的价值来自动态任务处理能力，它的风险也来自同一份自主性。
