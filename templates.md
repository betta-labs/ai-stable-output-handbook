...
模板不是“填完即可上线”的表单，而是帮助团队把边界、责任、证据和回退方式写清楚的控制资产。请根据你所在阶段选择一组，而不是一次性下载所有模板。

| 阶段 | 建议资产 | 进入位置 |
| --- | --- | --- |
| 选择第一个场景 | 用例立项、最小闭环、风险初筛 | [第 6 章](/handbook/design-a-minimum-closed-loop) · [附录 A](/appendices/reusable-checklists-and-templates) |
...
| 引入 Agent 与工具 | 记忆合约、工具控制卡、Agent 目标契约 | [第 9 章](/handbook/agent-and-automation-governance) · [附录 A](/appendices/reusable-checklists-and-templates) |
...
> 所有模板均以仓库当前版本为准。复用前请检查其中的版本、Owner、适用范围和待验证项。
