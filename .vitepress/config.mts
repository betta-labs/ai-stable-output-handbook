  ...
  transformHead(context) {
    ...
    const schema = isHome
      ? { '@context': 'https://schema.org', '@graph': [
        { '@type': 'WebSite', name: '企业 AI 稳定产出手册', url: SITE_URL, inLanguage: 'zh-Hans', description: DEFAULT_DESCRIPTION },
        { '@type': 'Book', name: '企业 AI 稳定产出手册', version: '2.0.0', inLanguage: 'zh-Hans', author: { '@type': 'Person', name: 'Jace' }, license: 'https://creativecommons.org/licenses/by-nc/4.0/deed.zh-hans', url: SITE_URL, sameAs: REPOSITORY_URL, description: DEFAULT_DESCRIPTION }
      ] }
      : { '@context': 'https://schema.org', '@type': 'Article', headline: title, description, inLanguage: 'zh-Hans', isPartOf: { '@type': 'Book', name: '企业 AI 稳定产出手册', url: SITE_URL }, mainEntityOfPage: canonical, author: { '@type': 'Person', name: 'Jace' } }
    return [
      ...
      ['meta', { property: 'og:image', content: `${SITE_URL}/og-handbook.svg` }],
      ['meta', { name: 'twitter:card', content: 'summary_large_image' }],
      ['meta', { name: 'twitter:title', content: title }],
      ['meta', { name: 'twitter:description', content: description }],
      ['meta', { name: 'twitter:image', content: `${SITE_URL}/og-handbook.svg` }],
